...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002220898510')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002220898510')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesarenarequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviesarenarequest')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moviesarenarequest')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviesarenarequest') # Support Chat Link Without https:// or @
